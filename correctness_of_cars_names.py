...
#assert car_names[5] == 'Kia Ceed'
#assert car_names[6] == 'Opel VIVARO'
#assert car_names[7] == 'Hyundai Kona Electric'
#assert car_names[8] == 'Volkswagen Polo'
#assert car_names[9] == 'Volvo V90'
